...
def _convert_root_rot_to_xyzw(root_rot: torch.Tensor, root_rot_format: str) -> torch.Tensor:
...
class MotionLib:
    ...
    def _load_motions(self, motion_file):
        ...
        motion_files, motion_weights, root_rot_format = self._fetch_motion_files(motion_file)
        ...
        for i in tqdm(range(num_motion_files), desc="[MotionLib] Loading motions"):
            ...
            root_rot = _convert_root_rot_to_xyzw(root_rot, root_rot_format)
    ...
    def _fetch_motion_files(self, motion_file: str):
        if motion_file.endswith(".yaml"):
            ...
            root_rot_format = motion_config.get("root_rot_format", "xyzw")
        ...
        return motion_files, motion_weights, root_rot_format
